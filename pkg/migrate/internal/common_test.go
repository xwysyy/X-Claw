...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.x-claw")
	assert.Equal(t, "/home/user/.x-claw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.x-claw/workspace/file.txt", "/home/user/.x-claw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".x-claw"), result)
}
