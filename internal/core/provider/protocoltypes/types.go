...
// This package defines the canonical protocol types for LLM providers.
//
// The goal is to keep these shapes stable because they are:
// - persisted in session JSONL traces (tool calls, messages),
// - used across providers/adapters,
// - used across tools and the agent loop.
//
// To keep existing import paths stable during refactors, pkg/providers/protocoltypes
